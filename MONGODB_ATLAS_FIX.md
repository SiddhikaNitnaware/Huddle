...
```
mongodb+srv://siddhikanitnaware0315_db_user:0PfNw2823Fim9cWk@cluster0.rwdzwj6.mongodb.net/huddle?retryWrites=true&w=majority
```

#### Option B: URL-Encoded Password (if special characters)
```
mongodb+srv://siddhikanitnaware0315_db_user:0PfNw2823Fim9cWk@cluster0.rwdzwj6.mongodb.net/huddle?retryWrites=true&w=majority&authSource=admin
```

#### Option C: Direct Connection (backup)
```
mongodb://siddhikanitnaware0315_db_user:0PfNw2823Fim9cWk@cluster0-shard-00-00.rwdzwj6.mongodb.net:27017,cluster0-shard-00-01.rwdzwj6.mongodb.net:27017,cluster0-shard-00-02.rwdzwj6.mongodb.net:27017/huddle?ssl=true&replicaSet=atlas-xyz123-shard-0&authSource=admin&retryWrites=true&w=majority
```
...
```bash
# Try Option A
echo 'MONGO_URI=mongodb+srv://siddhikanitnaware0315_db_user:0PfNw2823Fim9cWk@cluster0.rwdzwj6.mongodb.net/huddle?retryWrites=true&w=majority' > server/.env.backup1

# Try Option B  
echo 'MONGO_URI=mongodb+srv://siddhikanitnaware0315_db_user:0PfNw2823Fim9cWk@cluster0.rwdzwj6.mongodb.net/huddle?retryWrites=true&w=majority&authSource=admin' > server/.env.backup2
